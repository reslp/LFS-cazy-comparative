...
pars = argparse.ArgumentParser(prog="busco_orthology_to_cafe.py", description = """Converts the orthology file from funannotate to a CAFE input file""", epilog = """written by Philipp Resl 2019""")
