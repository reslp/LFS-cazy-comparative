...
print("Subsetting data to only sign. cazymes")
...
pdf(file=paste(outprefix,"/phly_pca.pdf", sep=""), width=11.7, height=5)
pp
dev.off()
...
pdf(file=paste(outprefix,"/normal_pca.pdf",sep=""), width=11.7, height=5)
pp
dev.off()
print("all done")
